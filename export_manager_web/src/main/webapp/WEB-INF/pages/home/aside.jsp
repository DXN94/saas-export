    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
           ...
           <%--<li class="treeview">
               ...
               <ul class="treeview-menu">
                   <li id="company-manager">
                       <a href="/company/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
                       <i class="fa fa-circle-o"></i>企业管理
                   </a>
                   </li>
                   <li id="module-manager">
                       <a href="/system/module/findAll.do" onclick="setSidebarActive(this)" target="iframe">
         ...
         <li class="treeview">
             ...
             <ul class="treeview-menu">
                 <li id="cargo-contract">
                     <a href="cargo/contract/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
                 ...
                 <li id="cargo-export">
                     <a href="/cargo/export/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
                         <i class="fa fa-circle-o"></i>出口报运
                     </a>
                 </li>
                 <li id="cargo-pack">
                     <a href="/cargo/packing/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
                         <i class="fa fa-circle-o"></i>装箱管理
                     </a>
                 </li>
                 <li id="cargo-ship">
                     <a href="/cargo/shipping/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
                         <i class="fa fa-circle-o"></i>委托管理
                     </a>
                 </li>
                 <li id="cargo-invoice">
                     <a href="/cargo/invoice/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
                         <i class="fa fa-circle-o"></i>发票管理
                     </a>
                 </li>
                 <li id="cargo-finance">
                     <a href="/cargo/finance/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
         ...
         <li class="treeview">
             ...
             <ul class="treeview-menu">
                 <li id="sys-dept">
                     <a href="/system/dept/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
                         <i class="fa fa-circle-o"></i>部门管理
                     </a>
                 </li>
                 <li id="sys-user">
                     <a href="/system/user/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
                         <i class="fa fa-circle-o"></i>用户管理
                     </a>
                 </li>
                 <li id="sys-role">
                     <a href="/system/role/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
                         <i class="fa fa-circle-o"></i>角色管理
                     </a>
                 </li>
                 <li id="sys-log">
                     <a href="/system/log/findAll.do" onclick="setSidebarActive(this)"  target="iframe">
