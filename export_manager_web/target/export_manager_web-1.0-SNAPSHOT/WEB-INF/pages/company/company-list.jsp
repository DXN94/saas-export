...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <!-- .box-footer-->
        <%--<form action="/company/findAll.do" method="post" id="pageForm">
        <div class="box-footer">
            ...
            <div class="box-tools pull-right">
                <ul class="pagination">
                    ...
                    <c:forEach var="i" begin="${page.beg}" end="${page.end}">
        ...
        <%--<form id="pageForm" action="/company/findAll.do" method="post">
        <div class="box-footer">
            <div class="pull-left">
                <div class="form-group form-inline">
                    总共${page.totalPage} 页，共${page.total} 条数据。 每页
                    <select class="form-control" name="size" onchange="javascript:goPage()">
                        <option value="2" ${page.size==2? "selected":""}>2</option>
                        <option value="3" ${page.size==3? "selected":""}>3</option>
        ...
        <div class="box-footer">
            <jsp:include page="../common/page.jsp">
                <jsp:param value="${ctx}/company/findAll.do" name="pageUrl"/>
            </jsp:include>
        </div>
        <!-- /.box-footer-->
